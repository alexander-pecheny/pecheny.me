...
# Классические розы {#roses}

## Первый день календарной весны {#calendar}
...
## Сказочка про белого бычка {#tale}
...
## Претензия на оригинальность {#origin}
...
## Символичность ординарных событий {#symbolic}
...
## Скрытые предпосылки торжества истины {#truth}
...
## Негатив или инвертное восприятие действительности {#negative}
...
## Разрисованный фиолетовыми красками мир {#violet}
...
## Конкретно всеобщая теория развития {#theory}
...
## Проблема тождества самому себе {#problem}
...
## Северный ветер над холодной страной {#russia}
...
## Мизантроп (песня для Панамы) {#misanthrope}
...
# Постмодернистские частухи {#chastuxi}
